      ...
      <div v-else-if="boards.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <div class="grid grid-cols-3 gap-4 mb-4">
            <div class="text-center">
              <div class="text-2xl font-bold text-primary-600">{{ getTaskCount(board._id) }}</div>
          ...
          <div class="flex items-center space-x-2">
            <div class="flex -space-x-2">
              <div
                ...
                :key="member.user._id"
                class="w-8 h-8 rounded-full bg-primary-500 text-white flex items-center justify-center text-xs font-medium border-2 border-white"
