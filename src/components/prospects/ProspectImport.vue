    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] flex flex-col overflow-hidden">
      ...
      <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
        <div class="flex items-center gap-3">
          <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-500 to-primary-500 flex items-center justify-center text-white shadow-lg shadow-cyan-500/30">
      ...
      <div v-else-if="step === 'importing'" class="flex-1 flex items-center justify-center p-12">
        <div class="text-center max-w-sm">
          ...
          <div class="h-1.5 bg-slate-100 rounded-full overflow-hidden">
            <div class="h-full bg-gradient-to-r from-cyan-500 to-primary-500 transition-all" :style="{ width: progressPct + '%' }"></div>
          </div>
        </div>
      </div>
