    ...
    >
      ...
      <div class="bg-gradient-to-r from-primary-600 to-primary-700 p-4 flex items-center justify-between">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h3 class="text-white font-semibold">GEMS Chat</h3>
      ...
      <div class="flex-1 flex">
        ...
        <div class="flex-1 flex flex-col">
          ...
          <div class="p-3 bg-gray-800/50 border-b border-gray-700 flex items-center justify-between">
            <div class="flex items-center gap-3">
              <div class="w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold text-white bg-gradient-to-r from-primary-500 to-primary-600">
                G
              </div>
              <div>
              ...
              <div class="max-w-[70%] group">
                <div class="bg-gradient-to-r from-primary-600 to-primary-700 text-white px-4 py-2 rounded-2xl rounded-br-lg">
                  ...
                  <div class="text-xs mt-1 opacity-70 text-purple-200">
                    10:35 AM
                    <i class="fas fa-check-double ml-1 text-primary-300"></i>
                  </div>
                </div>
              </div>
            </div>
