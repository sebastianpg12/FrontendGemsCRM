    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
      <div class="bg-gradient-to-br from-primary-500/20 to-primary-600/10 rounded-2xl p-6 border border-primary-500/20">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-primary-400 text-sm font-medium">Total Casos</p>
            <p class="text-2xl font-bold text-white">{{ totalCases }}</p>
          </div>
          <div class="p-3 bg-primary-500/20 rounded-full">
            <i class="fas fa-folder text-primary-400 text-xl"></i>
          </div>
        </div>
      </div>
...
const getTypeClass = (tipo: string) => {
  const classes: Record<string, string> = {
    documento: 'bg-primary-500/20 text-primary-400 border border-primary-500/30',
...
const getStatusClass = (estado: string) => {
  const classes: Record<string, string> = {
    abierto: 'bg-primary-500/20 text-primary-400 border border-primary-500/30',
