<template>
  <div>
    ...
    >
      <div class="bg-gray-800 rounded-xl w-full max-w-3xl p-5 relative shadow-lg border border-primary-500/30">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-3 bg-gray-700/30 p-3 rounded-lg">
            ...
            <div class="col-span-1 md:col-span-2 flex flex-wrap gap-2 mt-2">
              ...
              <button 
                ...
                class="px-3 py-1 bg-primary-600 hover:bg-primary-500 text-xs text-white rounded transition-colors"
              >
                Seleccionar todas
              </button>
              <button 
          ...
          <div class="flex justify-between items-center mt-4">
            ...
            <div class="space-x-3">
              ...
              <button 
                ...
                class="px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg transition-colors text-sm disabled:opacity-50 disabled:cursor-not-allowed"
              >
