<template>
  <div class="space-y-6">
    <!-- Filtros -->
    <div class="grid grid-cols-1 md:grid-cols-4 gap-3 bg-gradient-to-r from-gray-800/70 to-gray-900/70 backdrop-blur-sm p-5 rounded-xl border border-primary-500/20">
      <!-- Título -->
      ...
      <div class="md:col-span-4">
        <div class="relative">
          <input
            ...
            class="w-full bg-gray-700 border border-gray-600 rounded-lg pl-10 pr-3 py-2 text-sm text-white placeholder-gray-400 focus:ring-2 focus:ring-primary-500 focus:border-transparent"
          />
      ...
      <div>
        ...
        <select 
          ...
          class="w-full bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 text-sm text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
        >
      ...
      <div>
        ...
        <div class="grid grid-cols-2 gap-2">
          <input
            ...
            type="date"
            class="bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 text-sm text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
          />
          <input
      ...
      <div class="md:col-span-4 flex flex-wrap gap-2 mt-2">
        ...
        <button 
          ...
          class="px-4 py-2 bg-primary-600 hover:bg-primary-500 text-sm text-white rounded-lg transition-colors"
        >
          <div class="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <thead class="bg-gray-800">
            <tr>
              <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider w-10">
                <input 
                  type="checkbox" 
                  class="form-checkbox h-4 w-4 text-primary-600 rounded focus:ring-primary-500 border-gray-600 bg-gray-700"
    ...
    <div class="flex justify-end mt-4">
      <button 
        ...
        class="px-5 py-2.5 bg-primary-600 hover:bg-primary-700 text-white rounded-lg transition-colors text-sm flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
      >
...
function getStatusClass(status: string) {
  const classes = {
    ...
    'in-progress': 'bg-primary-900/40 text-primary-300',
