...
.wiki-content h1 { font-size: 1.875rem; font-weight: 800; margin: 1.5rem 0 0.75rem; color: #0f172a; line-height: 1.2; }
.wiki-content h2 { font-size: 1.5rem;   font-weight: 800; margin: 1.25rem 0 0.5rem; color: #0f172a; line-height: 1.3; }
.wiki-content h3 { font-size: 1.125rem; font-weight: 700; margin: 1rem 0 0.5rem;   color: #1e293b; }
.wiki-content h4 { font-size: 1rem;     font-weight: 700; margin: 0.75rem 0 0.4rem; color: #334155; }
.wiki-content p  { margin: 0.5rem 0; }
.wiki-content ul, .wiki-content ol { padding-left: 1.5rem; margin: 0.5rem 0; }
.wiki-content ul li, .wiki-content ol li { margin: 0.25rem 0; }
...
.wiki-content table td, .wiki-content table th { border: 1px solid #e2e8f0; padding: 0.5rem 0.75rem; vertical-align: top; }
.wiki-content table th { background: #f1f5f9; font-weight: 700; text-align: left; }

/* ── Dark mode ──────────────────────────────────────────────────── */
.dark .wiki-content { color: #cbd5e1; }
.dark .wiki-content h1 { color: #f1f5f9; }
.dark .wiki-content h2 { color: #e2e8f0; }
.dark .wiki-content h3 { color: #cbd5e1; }
.dark .wiki-content h4 { color: #94a3b8; }
...
.dark .wiki-content hr { border-top-color: #334155; }
.dark .wiki-content a { color: #a78bfa; }
.dark .wiki-content mark { background: rgba(251,191,36,0.25); color: #fbbf24; }
.dark .wiki-content table td,
.dark .wiki-content table th { border-color: #334155; color: #cbd5e1; }
.dark .wiki-content table th { background: #1a2438; color: #94a3b8; }
.dark .wiki-content table tr:nth-child(even) td { background: rgba(30,41,59,0.5); }
</style>
