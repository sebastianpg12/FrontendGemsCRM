<template>
  <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
    ...
    <!-- Modal content -->
    <div class="w-full max-w-5xl max-h-[90vh] overflow-y-auto bg-gradient-to-br from-dark-800 to-dark-900 rounded-xl border border-primary-500/20 shadow-2xl relative z-10 animate-fadeIn">
      <!-- Header -->
