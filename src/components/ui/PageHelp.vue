<template>
  <Teleport to="body">
    ...
    <button
      v-if="pageHelp"
      @click="open = true"
      class="fixed z-[180] w-8 h-8 rounded-full bg-white dark:bg-[#1e293b] border border-slate-200 dark:border-[#334155] shadow-md flex items-center justify-center text-slate-400 dark:text-slate-500 hover:text-primary-600 dark:hover:text-primary-400 hover:border-primary-400 transition-all duration-150 hover:scale-110"
